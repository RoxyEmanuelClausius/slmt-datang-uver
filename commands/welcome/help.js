...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const emx = new MessageEmbed()
      ...
      **Tags** : **Info** : **Example**
      ?user : Display username only : Roxy
      ?tag : Display username with tag : Roxy Emanuel Clausius#0001
      ?mention : Mention user in description : <@940460103272914994>
      ?server : Display server name : Uverseni
      ?rank : Position to join server : 03th Member
